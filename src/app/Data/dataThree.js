...
export const corporateAbout = [
    {
        ...
        desc:"Building community fosters unity, support, collaboration, and growth among individuals.", 
    },
    {
        icon:LiaFileInvoiceDollarSolid,
        title:"Train Members",
        desc:"Training members enhances skills, knowledge, productivity, and teamwork within a group.", 
    },
    {
        icon:LiaMoneyCheckAltSolid,
        title:"Help People",
        desc:"We aid individuals by offering support, care, and resources universally.", 
    },
    {
        icon:RiPresentationFill,
        title:"Find Us Easily",
        desc:"Customers easily access our association for their specific program needs.", 
    },
]
